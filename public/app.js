/* >>>>CURRENT PROBLEM 1.6: Well shit. Nevermind. Now it doesn't propery
check to see if there is a user anymore. Also, I have an empty 'else' clause
down in anonLogin and I dunno what that's about. I'm pretty turned around and tired.
I need to reassess what's happening with the login.
*/
...
document.addEventListener("DOMContentLoaded", event => {
  ...
  var userCheckComplete = false;
  if (userCheckComplete = false){
    firebase.auth().onAuthStateChanged(user => checkForUser(user));
  } //checkForUser sets userCheckComplete value to 'true'
});
