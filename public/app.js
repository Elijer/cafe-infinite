...
function uploadFile(files){
  //having problems getting the tutorial to work but this was lookin promising: https://firebase.googleblog.com/2016/07/5-tips-for-firebase-storage.html

  /*var storage = firebase.storage();
  var pathReference = storage.ref('horse.jpg');
  var gsReference = storage.refFromURL()*/
  const storageRef = firebase.storage().ref();
  //this creates and names a new child/item/whatever in storage
  const horseRef = storageRef.child('horse.jpg');
  //takes first item in files list generated by input tag in html
